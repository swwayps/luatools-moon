...
Linux port of the `ltsteamplugin` plugin, built exclusively for the [slsteam-moon](https://github.com/luatools-linux/slsteam-moon) project. It serves as an integration layer that fetches manifest packs and installs them for slsteam-moon to consume natively on Linux.
