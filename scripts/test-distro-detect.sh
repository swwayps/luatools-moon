...
# A GitHub outage is not "no internet" when the release mirror is reachable.
...
case "$internet_out" in
	*"Internet reachable"*|*"Internet acessível"*) r=0 ;;
	*) r=1 ;;
esac
check "GitHub outage: connectivity success is reported" "$r"
