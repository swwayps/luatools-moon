...
# identity ("diaguser") regardless of who runs the test.
#
...
export SCRUB_USER="diaguser"
export SCRUB_HOME="/home/diaguser"
...
masks "home path -> /home/USER" \
	'[Debug] Added /home/diaguser/.config/SLSsteam/config.yaml to FileWatcher 6' \
	'/home/USER/.config/SLSsteam' '/home/diaguser'

masks "other user's home -> /home/USER" \
	'log-file=/home/tester/.local/share/Steam/logs/cef_log.txt' \
	'/home/USER/.local/share/Steam' '/home/tester'

masks "bare username token -> USER" \
	'persona for diaguser loaded' \
	'USER' 'diaguser'

masks "Steam account id (userdata/<id>) -> ACCOUNTID" \
	'removing shader hit cache: /home/diaguser/.steam/steam/userdata/488150314/config/x' \
	'userdata/ACCOUNTID' '488150314'

masks "CloudRedirect storage/<id> -> ACCOUNTID" \
	'storage path: /home/diaguser/.config/CloudRedirect/storage/488150314/2057760' \
...
masks "IPv4 -> IP" \
	'connected to 203.0.113.99:27017' \
	'IP' '203.0.113.99'
